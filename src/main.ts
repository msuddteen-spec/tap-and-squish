...
const bread = createBread(); scene.add(bread); const raycaster = new THREE.Raycaster(); const pointer = new THREE.Vector2(); const targetSquish = new THREE.Vector3(1, 1, 1); const targetIndent = new THREE.Vector3(); const indent = new THREE.Vector3(); let isPressing = false; let hasPressed = false;
